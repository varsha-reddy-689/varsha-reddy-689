...
- 🏢 Previously worked at **Accenture** and **Yellow.ai**
- 🤖 Built AI chatbot applications, backend workflows, automation frameworks, and REST API integrations
- 🧠 Interested in **Backend Engineering, AI/ML, Computer Vision, NLP, Generative AI, and Distributed Systems**
- 🔍 Currently looking for **SWE / Backend / AI Engineer / ML Engineer** opportunities
- ⚡ Fun fact: I enjoy turning messy ideas into working systems and clean code
...
![RAG](https://img.shields.io/badge/RAG-Retrieval_Augmented_Generation-FF6B35?style=for-the-badge)
...
```text
Backend Engineering + AI/ML + Distributed Systems
